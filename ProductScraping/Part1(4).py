...
response = requests.get("https://www.amazon.in/s?k=baby+dress&crid=2OGDIW7VQF2HI&sprefix=baby+dre%2Caps%2C280&ref=nb_sb_ss_ts-doa-p_1_8")
...
names = soup.find_all('span',class_='a-size-base-plus a-color-base')
#print(names)
product_name = []
